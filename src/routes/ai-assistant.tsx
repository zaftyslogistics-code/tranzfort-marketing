...
const pillars = [
  {
    icon: Cpu,
    t: "Local On-Device AI",
    d: "Runs entirely on your phone using a tuned small-language-model. No round-trip to a server. Sub-100ms responses, every time.",
  },
  {
    icon: WifiOff,
    t: "Truly Offline",
    d: "Tunnels, dead zones, rural India, the middle of a long ghat — the AI keeps thinking. Syncs results when signal returns.",
  },
  {
    icon: Languages,
    t: "Hindi & English",
    d: "Native bilingual understanding. Switch mid-sentence. हम समझते हैं — and reply in whichever language you used.",
  },
  {
    icon: Mic,
    t: "Voice-First (TTS · STT)",
    d: "Speak commands. Hear answers. Eyes on the road, hands on the wheel — designed for life behind the wheel.",
  },
  {
    icon: Bot,
    t: "Domain-Tuned",
    d: "Fine-tuned on trucking, lanes, LRs, GST, fuel pricing, and Indian logistics workflows. Not a generic chatbot.",
  },
  {
    icon: Lock,
    t: "Private by Design",
    d: "Sensitive load data never leaves your device unless you choose to sync. End-to-end encrypted when it does.",
  },
];

const examples = [
  {
    q: "Find me steel loads near Pune for tomorrow",
    a: "Found 12 matches. Top 3: Pune→Mumbai (₹28K), Pune→Aurangabad (₹19K), Pune→Nashik (₹16K). Open all?",
  },
  {
    q: "मुंबई से दिल्ली का best रास्ता क्या है",
    a: "NH48 via Surat-Vadodara — 1,420 km, ETA 26h, ₹4,200 toll. 2 fuel stops suggested. नक्शा दिखाऊं?",
  },
  {
    q: "Scan this LR",
    a: "✓ Done. Consignor: ABC Steels. Consignee: Mumbai Port. Weight: 24T. GST: 27ABCDE1234F1Z5. Save to records?",
  },
  {
    q: "Mera RC kab expire hota hai",
    a: "आपका RC 14 March 2027 को expire होगा — अभी 11 महीने बाकी हैं। Renewal reminder set कर दूं?",
  },
];
  ...
  return (
    <SiteLayout>
      ...
      <PageHero
        ...
        title={
          <>
            A local AI that <span className="text-gradient-brand">never sleeps</span>.
          </>
        }
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="max-w-7xl mx-auto px-5 lg:px-8 grid lg:grid-cols-5 gap-14 items-center">
          ...
          >
            ...
            <div
              className="absolute w-48 h-48 rounded-full border-2 border-orange/40 animate-pulse-ring"
        ...
        <div className="relative max-w-5xl mx-auto px-5 lg:px-8">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="mt-4 text-lg text-white/70">
              Hindi, English, or both at once. The AI keeps up.
            </p>
          </div>
            ...
            {examples.map((ex, i) => (
              ...
              >
                <div className="flex justify-end">
                  <div className="bg-orange text-white text-sm px-4 py-2.5 rounded-2xl rounded-br-md max-w-[85%]">
                    {ex.q}
                  </div>
                </div>
            ...
            {[
              {
                ...
                a: "Yes. We ship a quantised, domain-tuned small-language-model (~1B parameters) along with TTS and STT engines that run on your phone's CPU/NPU. No internet needed for chat, voice or scanning.",
              },
              {
                q: "What languages does it understand?",
                a: "Hindi and Indian English natively, including Hinglish code-switching mid-sentence. Regional language support (Marathi, Tamil, Telugu, Punjabi) is rolling out in 2026.",
              },
              {
                q: "Where does my data go?",
                a: "By default — nowhere. Voice, chat and scanned documents stay on your device. You can opt-in to sync conversations to your TranZfort account, end-to-end encrypted.",
              },
              {
                q: "Will it slow down my phone?",
                a: "No. The model loads only when you invoke it and uses about 400 MB of RAM. Compatible with any phone running Android 9+ or iOS 15+.",
              },
              {
                q: "Can my fleet build custom workflows?",
                a: "Yes. Enterprise plans include custom intents, integrations with your TMS, and access to our model fine-tuning sandbox.",
              },
            ].map((x, i) => (
              <details
                key={i}
