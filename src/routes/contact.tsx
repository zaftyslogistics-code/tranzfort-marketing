  ...
  return (
    <SiteLayout>
      ...
      <PageHero
        ...
        title={
          <>
            Let's <span className="text-gradient-brand">talk logistics.</span>
          </>
        }
          ...
          <div className="p-8 rounded-3xl bg-card border border-border shadow-soft">
            ...
            {sent ? (
              ...
              >
                ...
                <div>
                  <label htmlFor="topic" className="text-sm font-medium block mb-1.5">
                ...
                <div>
                  <label htmlFor="msg" className="text-sm font-medium block mb-1.5">
                    Message
                  </label>
                  <textarea
                    id="msg"
                ...
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 bg-gradient-brand text-white font-semibold px-6 py-3 rounded-full shadow-brand"
                >
            ...
            {[
              {
                icon: Mail,
                t: "Email",
                d: "support@tranzfort.com",
                sub: "Reply within 24 hours",
                href: "mailto:support@tranzfort.com",
              },
              {
                icon: Phone,
                t: "Phone",
                ...
                href: "tel:+91-927-092-3581",
              },
              {
                icon: MessageSquare,
                t: "WhatsApp Support",
                d: "+91-927-092-3581",
                sub: "Hindi & English · 24/7",
                href: "tel:+91-927-092-3581",
              },
              {
                icon: MapPin,
                t: "Headquarters",
                d: "World Trade Center, Kharadi",
                sub: "Pune, India - 411014",
                href: null,
              },
              {
                icon: Clock,
                t: "Support Hours",
                d: "24/7 in-app support",
                sub: "Live chat in Hindi & English",
                href: null,
              },
            ].map((x) => (
              <div
              ...
              >
                ...
                <div>
                  ...
                  {x.href ? (
                    <a href={x.href} className="font-bold mt-0.5 hover:text-teal transition-colors">
                      {x.d}
                    </a>
                  ) : (
